...
class Settings(BaseSettings):
    ...
    default_model_type: str = Field(default="ollama", description="Default model: ollama, gemini, openai")
    default_model_name: str = Field(default="llama3.1", description="Default model name")
